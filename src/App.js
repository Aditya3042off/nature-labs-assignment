        ...
        <div className="row">
          ...
          <div className="col-7 ">
            ...
            <div>
              ...
              >
                <span style={{ width: "25%" }}>ASSET</span>
                <span style={{ width: "25%" }}>AMOUNT</span>
                <span style={{ width: "25%" }}>USER ACCOUNT</span>
                <span style={{ width: "25%" }}>REFERAL EARNING</span>
              </div>
              <div>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    <spam>{userData ? userData.asset : " "}</spam>
                    <spam
                      style={{
                        display: "flex",
                        flexDirection: "row",
                    ...
                    >
                      ...
                      <span>{userData ? userData.chain.name : " "}</span>
                    </spam>
                  </spam>
                  <spam
                    style={{
